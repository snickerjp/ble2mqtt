...
# class CookerProgramPredefined(Enum):
#     RICE = 'rice'
#     SLOW_COOKING = 'slow_cooking'
#     PILAF = 'pilaf'
#     FRYING_VEGETABLES = 'frying_vegetables'
#     FRYING_FISH = 'frying_fish'
#     FRYING_MEAT = 'frying_meat'
#     STEWING_VEGETABLES = 'stewing_vegetables'
#     STEWING_FISH = 'stewing_fish'
#     STEWING_MEAT = 'stewing_meat'
#     PASTA = 'pasta'
#     MILK_PORRIDGE = 'milk_porridge'
#     SOUP = 'soup'
#     YOGURT = 'yogurt'
#     BAKING = 'baking'
#     STEAM_VEGETABLES = 'steam_vegetables'
#     STEAM_FISH = 'steam_fish'
